...
function Experience({ id, logo, tasks, skills }: Props) {
  ...
  return (
    ...
    >
      <div className={styles.experienceHead} onClick={showExperienceDetails}>
        ...
        <img
          src="down-arrow.svg"
          className={`${styles.downArrow} ${showDetails ? styles.rotate : ""}`}
          alt="down arrow"
        />
      </div>
      ...
      <div
        className={
          showDetails ? styles.experienceDetailsShow : styles.experienceDetails
        }
      >
